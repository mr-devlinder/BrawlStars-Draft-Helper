...
export default createMapRecommendationProfile({
  ...
  notes:
    "Dueling Beetles is a sustained zone-control Hot Zone map. Draft should prioritize one zone anchor, one damage/control hybrid, and one agro flanker. Synergies like Ruffs/Griff with Najia or Pierce and Gray with Emz/Draco create strong conversion pressure on zones.",
})