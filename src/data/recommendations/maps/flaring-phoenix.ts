...
export default createMapRecommendationProfile({
  ...
  notes:
    "Flaring Phoenix is a precision Knockout map where ranged control and final-push agro decide rounds. Prioritize safe ranged control, then add a single finisher to punish positioning mistakes.",
})