...
export default createMapRecommendationProfile({
  ...
  notes:
    "Gem Fort emphasizes sustained mid control and anti-tank drafting. Prioritize one tank counter, one aggressive/control pick, and one reliable gem carrier. Alli becomes much stronger alongside Chester, Meeple or Janet provide excellent support for Chester or Otis, and Griff pairs exceptionally well with Pierce or Najia."
})